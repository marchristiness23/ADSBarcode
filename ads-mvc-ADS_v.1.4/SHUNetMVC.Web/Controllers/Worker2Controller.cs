...
{
    public class Worker2Controller : BaseCrudController<WorkerDto, WorkerDto>
    {
        private IWorkerService _service;
        public Worker2Controller(IWorkerService crudSvc, ILookupService lookupSvc) : base(crudSvc, lookupSvc)
        {
            _service = crudSvc;
        }
